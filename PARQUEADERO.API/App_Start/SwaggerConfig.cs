...
namespace PARQUEADERO.API
{
    public class SwaggerConfig
    {
        ...
        {
            return Path.Combine(System.Web.HttpRuntime.AppDomainAppPath, "bin", "PARQUEADERO.API.xml");
        }
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.ApiKey("Authorization")
                            .Description("Introduzca el tocken JWT")
                            .Name("Bearer")
                            .In("header");
                        //
                        //c.OAuth2("oauth2")
